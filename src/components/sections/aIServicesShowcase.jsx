                    ...
                    <div className="row align-items-end justify-content-between" data-animation="fade-down" >
                        <div className="col-xl-6 col-lg-7 col-md-7">
                            <div className="title-content">
                                <h2>Transforming Your World with Innovation</h2>
                            </div>
                        </div>
                        <div className="col-xl-5 col-lg-5 col-md-5">
                            <div className="title-content">
                                <p>Cutting-edge technology is reshaping how we live and work. Our innovative services are crafted to drive your business forward into the future.</p>
                            </div>
                        </div>
                    </div>
                </div>
